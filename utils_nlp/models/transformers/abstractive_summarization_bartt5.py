...
GERMAN_PRETRAINED_T5 = ['airKlizz/t5-base-with-title-multi-de-wiki-news', 'airKlizz/t5-small-multi-combine-wiki-news', 'airKlizz/t5-base-multi-de-wiki-news']

GERMAN_PRETRAINED_BART = ['sshleifer/distillmbart-12-6', 'sshleifer/tiny-mbart']
...
MODEL_CLASS.update(
    {k: BartForConditionalGeneration for k in GERMAN_PRETRAINED_BART}
)
MODEL_CLASS.update(
    {k: T5ForConditionalGeneration for k in T5_PRETRAINED_MODEL_ARCHIVE_MAP}
)
MODEL_CLASS.update(
    {k: T5ForConditionalGeneration for k in GERMAN_PRETRAINED_T5}
)
